...
const Person_image = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <div>
          <Link to={`/user/Person_image/view`} style={{ textDecoration: "none" }}>
            <button
              style={{
                border: 0,
      ...
      <div className="homeContainer">
        ...
        <div className="TopSearchContainer">
          <div className="TopSearchContainerLeft">
            ...
            รูปถ่ายของผู้ป่วยที่ได้มีการบันทึกไว้ล่าสุด
            </span>
          </div>
        </div>
        <div className="ListContainerTop">
          <div className="searchContainer">
            ...
            <div className="bottom">
              <Link to={`/user/Person_image/add`} style={{ textDecoration: "none" }}>
