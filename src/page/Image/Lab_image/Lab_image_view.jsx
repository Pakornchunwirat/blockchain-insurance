...
import "../Person_image/Person_image_add.css";
...
const Lab_image_view = () => {
  const [selectedFileName, setSelectedFileName] = useState("example.jpg"); // Set initial file name here
        ...
        <div className="DataContainer">
          <div className="DataContainerTop">
            ...
            <div className="bottom">
              <Link to={`/user/Lab_image`} style={{ textDecoration: "none" }}>
