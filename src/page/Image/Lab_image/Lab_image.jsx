...
const Lab_image = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => (
        <div>
          <Link to={`/user/Lab_image/view`} style={{ textDecoration: "none" }}>
            <button
              style={{
                border: 0,
      ...
      <div className="homeContainer">
        ...
        <div className="TopSearchContainer">
          <div className="TopSearchContainerLeft">
            ...
            รูปภาพที่เป็นผลจากห้องปฏิบัติการ เช่น X-Ray, CT Scan, EKG, etc.
            </span>
          </div>
        </div>
        <div className="ListContainerTop">
          <div className="searchContainer">
            ...
            <div className="bottom">
              <Link to={`/user/Lab_image/add`} style={{ textDecoration: "none" }}>
